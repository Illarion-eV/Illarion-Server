...
class CCharacter : private boost::noncopyable {
	...
	public:
        ...
        */
        inline virtual bool actionRunning() { return false; } 
        ...
        */
		inline unsigned short get_magic_type() { return magic.type; }
        ...
        */
		inline virtual void set_magic_type(magic_type newMagType) {magic.type=newMagType; }
		
		void setOnRoute( bool onr){ _is_on_route = onr; }
		
		bool getOnRoute(){ return _is_on_route; }
        ...
        */
		inline virtual const short unsigned int getPlayerLanguage() {return 1;} //mother_tongue} //nothing to do at all
        ...
        */
		inline unsigned long int get_magic_flags( unsigned char type ) { return magic.flags[type]; }
        ...
        * @see character_type
        */
        inline unsigned short get_character() { return character; }
        ...
        */
		inline unsigned short get_race() { return race; }
        ...
        */                                                       
		inline virtual bool isAdmin() { return false; }
        ...
        */        
        inline virtual TYPE_OF_CHARACTER_ID getType(){ return 0; }
        ...
        */
		inline short int getPoisonValue() { return poisonvalue; }
        ...
        */
        inline virtual void changeSource( ScriptItem sI ){ /**nothing to do only for player**/ }
        ...
        */
        inline virtual void changeSource( position pos ){ /**nothing to do only for player**/ }   
        
        /**
        *changes the Source of the last action to nothing for this character
        *<b>Lua: [:changeSource]</b>
        */
        inline virtual void changeSource(){ /**nothing to do only for player**/ }
        ...
        */
        inline virtual void changeTarget( ScriptItem sI ){ /**nothing to do only for player**/ }
        ...
        */
        inline virtual void changeTarget( position pos ){ /**nothing to do only for player**/ }
        
        /**
        *changes the Target of the last action to nothing for this character
        *<b>Lua: [:changeTarget]</b>
        */
        inline virtual void changeTarget(){ /**nothing to do only for player**/ }
        ...
        */
		inline int getMentalCapacity() { return mental_capacity; }
        ...
        */
		inline void setMentalCapacity(int value) { mental_capacity = value; }
        ...
        */
        ...
        virtual void setDeathConsequences(bool dc){ death_consequences = dc; }
        virtual bool getDeathConsequences() const { return death_consequences; } 
...
chicken=62
        ...
        */        
		...
		inline virtual bool getClippingActive() { return true; }
        
        /**
        * sets the inform state of a character
        * @param newInformChar the new inform state of this character
        */
		inline virtual void setInformChar(bool newInformChar) {informCharacter=newInformChar;}
