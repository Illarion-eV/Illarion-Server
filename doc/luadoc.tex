...
\title{Lua documentation for Illarion scripting\\v5.24}
...
\end{quote}
\bool, \position \var{destination} \var{field}:\com{isWarp}{}
\begin{quote}
       Returns whether or not a field is a warp as well as the warp \var{destination}.
\end{quote}
\void \var{field}:\com{setWarp}{\position \var{destination}}
\begin{quote}
       Enables the field's warp and sets its \var{destination}.
\end{quote}
\void \var{field}:\com{removeWarp}{}
\begin{quote}
...
\chapter{Versions}
Version 5.24 (12.9.20)\\
* Add field:isWarp\\
* Add field:setWarp\\
* Add field:removeWarp\\
\\
Version 5.23 (9.7.20)\\
