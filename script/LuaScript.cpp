...
void LuaScript::init_base_functions() {
    ...
    [
        ...
        .def("addOffer", (void(MerchantDialog:: *)(TYPE_OF_ITEM_ID, std::string, TYPE_OF_WORTH))&MerchantDialog::addOffer)
        .def("addOffer", (void(MerchantDialog:: *)(TYPE_OF_ITEM_ID, std::string, TYPE_OF_WORTH, TYPE_OF_BUY_STACK))&MerchantDialog::addOffer)
        ...
        .def("inform", (void(Character:: *)(const std::string &, Character::informType) const)&Character::informLua)
        .def("inform", (void(Character:: *)(const std::string &, const std::string &, Character::informType) const)&Character::informLua)
