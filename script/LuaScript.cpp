...
void LuaScript::init_base_functions() {
    ...
    [
        ...
        .def("getSkinColor", &Character::getSkinColor, luabind::pure_out_value(_1) + luabind::pure_out_value(_2) + luabind::pure_out_value(_3))
        .def("setHairColor", &Character::setHairColor)
        .def("getHairColor", &Character::getHairColor, luabind::pure_out_value(_1) + luabind::pure_out_value(_2) + luabind::pure_out_value(_3))
