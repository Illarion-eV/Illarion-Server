...
void LuaScript::init_base_functions() {
    ...
    [
        ...
        .def("requestMerchantDialog", &Character::requestMerchantDialog)
        .def("requestSelectionDialog", &Character::requestSelectionDialog)
        ...
        .def("inform", (void(Character:: *)(std::string))&Character::informLua)
