...
CREATE TABLE server.player (
    ...
    ply_posx smallint DEFAULT 702 NOT NULL,
    ply_posy smallint DEFAULT 283 NOT NULL,
    ply_posz smallint DEFAULT 0 NOT NULL,
    ply_faceto smallint DEFAULT 4 NOT NULL,
