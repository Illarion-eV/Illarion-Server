...
auto character() -> Binding<Character> {
    ...
    return luabind::class_<Character>("Character")
            ...
            .def("talk", (void (Character::*)(Character::talk_type, const std::string &, const std::string &)) &
                                 Character::talk)
            ...
            .enum_("direction")[luabind::value("dir_north", dir_north), luabind::value("dir_northeast", dir_northeast),
                                luabind::value("dir_east", dir_east), luabind::value("dir_southeast", dir_southeast),
                                luabind::value("dir_south", dir_south), luabind::value("dir_southwest", dir_southwest),
                                luabind::value("dir_west", dir_west), luabind::value("dir_northwest", dir_northwest),
                                luabind::value("dir_up", dir_up), luabind::value("dir_down", dir_down)]
            .enum_("character_type")[luabind::value("player", Character::player),
                                     luabind::value("monster", Character::monster),
                                     luabind::value("npc", Character::npc)]
            .enum_("sex_type")[luabind::value("male", Character::male), luabind::value("female", Character::female)]
            .enum_("face_to")
                    [luabind::value("north", Character::north), luabind::value("northeast", Character::northeast),
                     luabind::value("east", Character::east), luabind::value("southeast", Character::southeast),
                     luabind::value("south", Character::south), luabind::value("southwest", Character::southwest),
                     luabind::value("west", Character::west), luabind::value("northwest", Character::northwest)]
            .enum_("race_type")[races]
            .enum_("inform_type")[luabind::value("lowPriority", Character::informScriptLowPriority),
