...
auto player() -> Binding<Player, Character> {
    return luabind::class_<Player, Character>("Player")
            ...
            .def("getDescriptionEn", &Player::getDescriptionEn)
            .def("setDescriptionEn", &Player::setDescriptionEn)
            .def("getDescriptionDe", &Player::getDescriptionDe)
            .def("setDescriptionDe", &Player::setDescriptionDe)
